...
/**
 * Serves as a connection between the {@link GameController} of the game and the
 * keyboard. It handles {@link KeyEvent} and calls the corresponding methods in
 * its {@link GameController}.
 */
public class KeyboardControllerHandler implements EventHandler<KeyEvent> {
	 ...
	 *            The {@link GameController} for the primary game.
	 * @param secondGameController
	 *            The {@link GameController} for the other game in the window, if
