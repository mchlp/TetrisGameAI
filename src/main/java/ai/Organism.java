...
/**
 * Represents an organism in the genetic algorithm training process. Among other
 * values, it stores a {@link Genome} and statistics of its past games. It
 * implements the {@link Serializable} interface to allow to it to be exported
 * to a file and loaded from a file for later use.
 */
public class Organism implements Serializable {
	...
	/**
	 * The name of this organism. Initially it is a string representation of a
	 ...
	 *
	 * @param loadFile
	 *            The file where the organism is stored.
	 * @return The organism loaded from the file.
	 * @throws IOException
	 *             An error has occurred when reading the file.
	 * @throws ClassNotFoundException
	 *             An {@link Organism} object cannot be found in the file.
	 */
	...
	/**
	 * The fitness of the organism is defined as the median of the scores of all the
	 * games this organism has played.
	 *
	...
	/**
	 * @return An integer representing the sum of the scores of all the games this
	 *         organism has played.
	 */
	...
	/**
	 * Generates a string which includes the details of the organism in a
	 * user-readable format.
	 *
	 * @return A string which contains the details of the organism, statistics of
